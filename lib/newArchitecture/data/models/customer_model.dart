...
CustomerModal customerModalFromJson(String str) => CustomerModal.fromJson(json.decode(str));
...
class CustomerModal {
  ...
  factory CustomerModal.fromJson(Map<String, dynamic> json) => CustomerModal(
    ...
    customeWishlist: List<dynamic>.from(json["custome_wishlist"].map((x) => x)),
    customeOrders: List<CustomeOrder>.from(json["custome_orders"].map((x) => CustomeOrder.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "custome_orders": List<dynamic>.from(customeOrders!.map((x) => x.toJson())),
